...
const MessageItem = ({ time, source, content, author, haveToRenderBasicDetails }) => {
	return (
		<StyledMessageItem className={`messageItem--${source} ${!haveToRenderBasicDetails ? "messageItem--detailsOmit" : ""}`}>
